...
function askProducts(){
    ...
    /** tomtamos todos los elementos */
    const elements = document.body.querySelectorAll('.m-product-card__name');

    if(elements.length==0) {requestAnimationFrame(askProducts); return};

    for( let i = 0 ; sku.length>i ; i++){
